...
lx_mesh_vertex_ref_t lx_mesh_vertex_list_head(lx_mesh_vertex_list_ref_t self) {
    lx_mesh_vertex_list_t* list = (lx_mesh_vertex_list_t*)self;
    lx_assert(list);
    return (lx_mesh_vertex_ref_t)lx_list_entry(&list->head, lx_list_entry_head(&list->head));
}

lx_mesh_vertex_ref_t lx_mesh_vertex_list_last(lx_mesh_vertex_list_ref_t self) {
    lx_mesh_vertex_list_t* list = (lx_mesh_vertex_list_t*)self;
    lx_assert(list);
    return (lx_mesh_vertex_ref_t)lx_list_entry(&list->head, lx_list_entry_last(&list->head));
}
