 ...
 */
static lx_bool_t lx_vk_descriptor_sets_init(lx_vulkan_device_t* device, lx_vk_pipeline_t* pipeline, const lx_uint32_t descriptor_type, const lx_uint32_t descriptor_count) {
