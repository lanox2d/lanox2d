...
lx_bool_t lx_bitmap_data_set(lx_bitmap_ref_t self, lx_pointer_t data, lx_size_t pixfmt, lx_size_t width, lx_size_t height, lx_size_t row_bytes, lx_bool_t has_alpha) {
